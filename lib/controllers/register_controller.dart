...
class RegisterController {
  ...
  final birthdayCtrl         = TextEditingController(); // يُملأ بصيغة yyyy-MM-dd للـ API
  final displayBirthdayCtrl  = TextEditingController(); // يُملأ بصيغة day/month/year للعرض فقط
  ...
  Future<void> register({
    ...
    required void Function(String message, Map<String, dynamic>? fieldErrors) onError,
  }) async {
    ...
    try {
      ...
      onError(
        DioClient.getErrorMessage(e),
        DioClient.getFieldErrors(e),
      );
    } catch (e) {
      onError('حدث خطأ غير متوقع: ${e.toString()}', null);
    }
  }
