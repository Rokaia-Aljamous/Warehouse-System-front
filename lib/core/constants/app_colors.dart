...
class AppColors {
  ...
  static Color get primary => ThemeController.instance.isDark ? _beige : _navy;
  ...
  static Color get cardBg => ThemeController.instance.isDark ? _navy : _beige;

  /// خلفية كارد ثابتة (بيج/أبيض دائماً بالوضعين) — لعناصر الكارد المتكررة
  /// متل كارد الطلبية وكارد المستودع، ما بتنعكس مع الدارك مود.
  static Color get cardFixedBg => _beige;

  /// لون نص/أيقونة/حدود ثابت (كحلي دائماً) فوق cardFixedBg، حتى يضل مقروء
  /// بالوضعين.
  static Color get cardFixedAccent => _navy;
  ...
  static const Color textPrimary = Color(
    0xFF1E3A5F,
  ); // نص داكن (فوق الأسطح الفاتحة الثابتة)
  ...
  /// نص فوق زر خلفيته كحلي ثابتة (cardFixedAccent) — أبيض بالـ Light Mode
  /// وبيج بالـ Dark Mode (بدل الأبيض الثابت)، حتى ينسجم مع لوحة ألوان
  /// الوضع الحالي.
  static Color get textOnFixedAccent =>
      ThemeController.instance.isDark ? _beige : Colors.white;
  static const Color purple = Color(
    0xFF7B61FF,
  ); // لون الأيقونات الجديد بالريجستر
